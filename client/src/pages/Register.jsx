...
import { Sparkles, Mail, Lock, User, Building, AlertCircle, Eye, EyeOff } from 'lucide-react';
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-10 py-2.5 bg-background/60 border rounded-xl text-white text-sm focus:outline-none focus:border-primary transition-colors placeholder:text-slate-600 ${
