          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="glass-card rounded-2xl p-6 border border-white/5 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1 md:col-span-2">
                  <label className="text-[10px] uppercase font-bold text-slate-400">Scheduled Date</label>
                  <input
                    type="datetime-local"
                    value={publishDate}
                ...
                <div className="px-6 py-4 border-b border-white/5 bg-white/5 flex flex-col sm:flex-row justify-between sm:items-center gap-4 shrink-0">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <button
                      ...
                      disabled={updateMutation.isPending}
                      className="px-4 py-2 bg-gradient-to-r from-primary to-accent text-background text-xs font-bold rounded-xl shadow-glow transition-all"
                    >
